# Ralph Wiggum Loops - Autonomous AI Coding

https://awesomeclaude.ai/ralph-wiggum

The **Ralph Wiggum Loop** is an autonomous AI agentic workflow—specifically a Bash script loop—that continuously runs coding tasks until a defined completion criteria is met.

It iteratively works through a feature list, implementing one task at a time until the project is complete.

## Few Notes

- Can definitely yield good results, especially for prototyping.
- Potentially costs **A LOT** of tokens.
- Trade-off: less control, more time for other work.
- When the agent enters a circular reasoning state, output quality degrades significantly; it can also get stuck.

## Example Implementation for Ralph Loop
